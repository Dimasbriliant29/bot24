...
console.log(color(figlet.textSync('./DIMAS_BRILIANT', {
		font: 'Small',
	...
	console.log(color(`${spc2}           [ Created by: ./DIMAS_BRILIANT ]` ,`${randomcolor}`))
	...
	console.log(color(`${spc3}                    [•]`, `${randomcolor}`), color(`Author      : ./DIMAS_BRILIANT`, `${randomcolor}`))
	console.log(color(`${spc3}                    [•]`, `${randomcolor}`), color(`Base Ori By : ./DIMAS_BRILIANT`, `${randomcolor}`))
	console.log(color(`${spc4}                       < =============================== >`, `${randomcolor}`))
...
danzz.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./Briliant.js")(danzz, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
