...
${symbol2} ${prefix}delete (msg) Ⓞ`
        ...
        rvn = fs.readFileSync(`./media/audio/buatapa.mp3`)
		danzz.sendMessage(m.chat, { audio: rvn, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
		//MODIF
break
case 'p': case 'pp': case 'ppp': case 'siapa ini': {
	let rules = `
	*gimana?*`
	let rulesnya = `
	*Ada Yang Dapat Saya Bantu?*`
                let buttons = [
                    ...
                    {buttonId: `donasi`, buttonText: {displayText: 'Donasi'}, type: 2},
                    {buttonId: `tqto`, buttonText: {displayText: 'Thanks To'}, type: 2}
                ]
                let buttonMessage = {
